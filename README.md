...
1) Place a bet before the game begins. It can be any value from $1 to your maximum balance. 
2) Player and dealer both start with 2 cards, and the dealer will have one hidden card.
...
10) TIE if both sides have the same value or both sides exceed 21.
